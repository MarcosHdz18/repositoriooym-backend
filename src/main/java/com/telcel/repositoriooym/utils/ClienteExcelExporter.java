...
public class ClienteExcelExporter {
     ...
     * @param clienteList lista de objetos de tipo Area
     */
    public ClienteExcelExporter(List<Cliente> clienteList) {
    ...
    private void writeDataLines() {
        ...
        for (Cliente cliente: clienteList) {
            ...
            int columnCount = 0;
            createCell(row, columnCount++, String.valueOf(cliente.getIdCliente()), style);
            createCell(row, columnCount++, cliente.getNombre(), style);
            createCell(row, columnCount++, cliente.getDescripcion(), style);
        }
    }
