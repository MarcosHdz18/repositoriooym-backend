...
public class TipoProyectoExcelExporter {
     ...
     * @param tipoProyectoList lista de objetos de tipo Area
     */
    public TipoProyectoExcelExporter(List<TipoProyecto> tipoProyectoList) {
    ...
    private void writeHeaderLine() {
        sheet = workbook.createSheet("Tipos de Proyecto");
    ...
    private void writeDataLines() {
        ...
        for (TipoProyecto tipoProyecto : tipoProyectoList) {
            Row row = sheet.createRow(rowCount++);
            int columnCount = 0;
            createCell(row, columnCount++, String.valueOf(tipoProyecto.getIdTipoProyecto()), style);
            createCell(row, columnCount++, tipoProyecto.getNombre(), style);
            createCell(row, columnCount++, tipoProyecto.getDescripcion(), style);
        }
    }
