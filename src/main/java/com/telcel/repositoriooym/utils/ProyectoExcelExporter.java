...
public class ProyectoExcelExporter {
    ...
    private void writeHeaderLine() {
        ...
        createCell(row, 2, "Fecha de Inicio", style);
        createCell(row, 3, "Fecha de liberación", style);
        createCell(row, 4, "Año", style);
        createCell(row, 5, "Nodos", style);
    ...
    private void writeDataLines() {
        ...
        for (Proyecto proyecto: proyectoList) {
            ...
            createCell(row, columnCount++, proyecto.getFechaInicio(), style);
