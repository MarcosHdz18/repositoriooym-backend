...
public class RegionExcelExporter {
     ...
     * @param regionList lista de objetos de tipo Area
     */
    public RegionExcelExporter(List<Region> regionList) {
    ...
    private void writeHeaderLine() {
        sheet = workbook.createSheet("Regiones");
    ...
    private void writeDataLines() {
        ...
        for (Region region: regionList) {
            ...
            int columnCount = 0;
            createCell(row, columnCount++, String.valueOf(region.getIdRegion()), style);
            createCell(row, columnCount++, region.getNombre(), style);
        }
    }
